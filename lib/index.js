 ...
 */
	...
	_createClass(Viz, [{
		key: 'compare',
		value: function compare(imageBuffer, imageTag) {
			if (!Buffer.isBuffer(imageBuffer)) {
				throw new TypeError('Expected imageBuffer to be of type <Buffer>, got ' + (typeof imageBuffer === 'undefined' ? 'undefined' : _typeof(imageBuffer)));
			}

			if (typeof imageTag !== 'string') {
				throw new TypeError('Expected imageTag to be of type <string>, got ' + (typeof imageTag === 'undefined' ? 'undefined' : _typeof(imageTag)));
			}
			...
			if (!this.storage.exists(imageTag, this.storage.LABELS.REF)) {
				...
				var testImg = _pngjs.PNG.sync.read(imageBuffer);
  ...
  */
		...
		key: 'base64Encode',
		value: function base64Encode(imageBuffer) {
			if (!Buffer.isBuffer(imageBuffer)) {
				throw new TypeError('Expected imageBuffer to be of type <Buffer>, got ' + imageBuffer);
			}
  ...
  */
		...
		key: 'base64Decode',
		value: function base64Decode(imageData) {
			if (typeof imageData !== 'string') {
				throw new TypeError('Expected imageData to be of type <String>, got ' + (typeof imageData === 'undefined' ? 'undefined' : _typeof(imageData)));
			}
